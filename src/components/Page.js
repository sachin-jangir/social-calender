const Page = () => {
    ...
    function rows() {
        ...
        for(let i = 0; i<data1.days.length; i++) {
          arr.push(
            ...
            <div className="card m-3 p-2 position-relative" style={{width: '350px', backgroundRepeat: 'no-repeat'

                }}>
                <p className="lead fw-bold ">{data1.days[i].day_of_the_week.toUpperCase()}</p>
                <h1>{data1.days[i].date}</h1>

                <div className="card-header">
                    {data1.days[i].card_header}
                </div>
                <div className="card-body">
                {data1.days[i].card_body}
                ...
                <div className="position-absolute top-100 start-50 translate-middle" style={{height: '40%', width: '50%', backgroundImage:
            data1.days[i].card_image? `url(${data1.days[i].card_image})`: ''}}>
  ...
  return (
    <div>
        <div className="d-flex justify-content-center align-items-center" style={{ height: '250px', backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)),  url(https://d23stw41ne88wu.cloudfront.net/upload/post/728f2eaa-ad39-4f0a-8606-caf0ace80e67.jpg)`  }}>
            <h1 className="text-white">
                {data1.calendar_banner_text}
            </h1>
        </div>
        ...
        {/* <div className="container">
            <div className="card m-3 p-2" style={{width: '350px'}}>
                <p className="lead fw-bold ">{data1.days[0].day_of_the_week.toUpperCase()}</p>
                <h1>{data1.days[0].date}</h1>
            </div>
